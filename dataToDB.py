...
def create_table(conn):
    ...
    :param conn: połączenie do bazy danych SQLite
    """
...
def insert_equipment_data(conn, data):
     """
    Wstawia dane o sprzęcie do tabeli w bazie danych.

    :param conn: połączenie do bazy danych SQLite
    :param data: dane o sprzęcie w postaci listy krotek
    """
...
def insert_service_data(conn, data):
    """
    Wstawia dane o przeglądzie do tabeli w bazie danych.

    :param conn: połączenie do bazy danych SQLite
    :param data: dane o przeglądzie w postaci listy krotek
    """
