...
def validate_date_format(date):
    ...
    :return: True, jeśli format daty jest poprawny, False w przeciwnym razie
    """
...
def validate_enum_value(enum_type, value):
    """
    Sprawdza poprawność wartości enum.

    :param enum_type: lista dostępnych wartości enum
...
def collect_data():
    ...
    :return: krotka zawierająca obiekty DataFrame dla danych o sprzęcie i przeglądzie
    """
...
def export_to_csv(dataframe, filename):
    ...
    :param dataframe: obiekt DataFrame zawierający dane
