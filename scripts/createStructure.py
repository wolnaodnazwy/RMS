...
def check_enum_type_exists(conn, enum_type_name):
    ...
    :return: True, jeśli typ enum istnieje, False w przeciwnym razie
    """
    cursor = conn.cursor()
...
def create_database_structure():
     """
    Tworzy strukturę bazy danych, tworząc typy enum i tabele.

    Uzyskuje połączenie do bazy danych, sprawdza istnienie typów enum
    i tabel, a następnie tworzy je, jeśli nie istnieją.
    """
