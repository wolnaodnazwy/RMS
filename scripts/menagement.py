...
def execute_script(script):
    """
    Wykonuje skrypt Pythona przy użyciu podprocesu.

    Args:
        script (str): Nazwa skryptu Pythona do wykonania.
    """
...
def main():
    ...
    Wyświetla menu opcji i obsługuje wybór użytkownika.
    """
    while True:
        print_menu()
        ...
        if choice == '1':
            ...
            param = input("Podaj nazwę tabeli: ")
