...
def create_table(cursor):
    """
    Tworzy tabelę 'data' oraz typy enum w bazie danych PostgreSQL, jeśli nie istnieją.

    Args:
        cursor: Kursor do bazy danych PostgreSQL.
    """
...
def insert_equipment_data(cursor, data):
     """
    Wstawia dane o sprzęcie do tabeli 'data' w bazie danych.

    Args:
        cursor: Kursor do bazy danych PostgreSQL.
        data: Lista krotek zawierających dane o sprzęcie.
    """
...
def insert_service_data(cursor, data):
    """
    Wstawia dane o przeglądzie do tabeli 'service' w bazie danych.

    Args:
        cursor: Kursor do bazy danych PostgreSQL.
        data: Lista krotek zawierających dane o przeglądzie.
    """
...
def main():
    ...
    Ładuje dane z plików CSV, tworzy tabelę w bazie danych PostgreSQL, wstawia dane do tabel, zatwierdza zmiany w bazie danych.
    """
