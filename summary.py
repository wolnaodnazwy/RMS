...
def generate_summary_report():
    """
    Generuje raport podsumowujący dane z bazy danych.

    Raport zawiera informacje na temat liczby urządzeń, liczby przeglądów,
    średniej liczby urządzeń na lokalizację oraz procentowego podziału przeglądów.
    Wygenerowany raport jest zapisywany jako plik CSV z załączonym plikiem obrazu wykresu.
    """
